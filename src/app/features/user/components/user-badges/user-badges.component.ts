...
@Component({
  ...
  <div class="flex flex-wrap gap-2">
    @for (b of badges$ | async; track $index) {
      <span class="inline-flex items-center gap-1 px-2 py-1 rounded-full text-[11px] font-medium border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-sm">
...
export class UserBadgesComponent {
  ...
  public readonly badges$ = this.state.verificationStatus$.pipe(map(v => {
